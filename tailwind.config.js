...
const defaultTheme = {
  ...
  extend: {
    ...
    fontFamily: {
      sans: ['Outfit', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'system-ui', 'Roboto', '"Helvetica Neue"', 'Arial', 'sans-serif'],
      serif: ['Cormorant', '"Playfair Display"', 'Georgia', '"Times New Roman"', 'Times', 'serif'],
